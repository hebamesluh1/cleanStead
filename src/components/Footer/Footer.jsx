    ...
    <div className="bg-footerBg rounded-t-2xl">
      <div className="p-5">
        <div className="flex justify-between flex-wrap  border-b border-white border-solid border-10 pb-10">
          <div className={"summary" + topSpace}>
            <div className="logo">
          ...
          <div className={"services" + topSpace}>
            <div className="title">
          ...
          <div className={"contact" + topSpace}>
            <div className="title">
              ...
              <ul>
                <li>
                  <a
                    href="tel:0592700722"
                    className="flex gap-2 items-center text-textColor"
                  >
                ...
                <li>
                  <a
                    href="mailto:eng.mohammedalhabil@gmail.com"
                    className="flex gap-2 items-center text-textColor"
                  >
            ...
            <div className="title">
              ...
              <div className="map flex items-center">
                ...
                <div className="map w-30">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13611.525320861896!2d34.38812925011669!3d31.472450438952443!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14fd8235ee6b864b%3A0xe4be51342e71e93b!2sAl%20Zahra!5e0!3m2!1sen!2s!4v1695055440500!5m2!1sen!2s"
                    width="100"
                    height="100"
                    allowfullscreen=""
                    loading="lazy"
